  ...
  <section class="section bg-black-transparent-0p3">
    ...
    <div class="main-text intro-text">
      ...
      <p>I&#39;ve been running it for over 10 years since I was 16, and by far the most popular system at my tables has
        been Dungeons and Dragons 5th Edition. My world building project I call 'The Materiae Existantiae' is my
        go to setting for it, and itself was built around the assumed setting that D&amp;D functions around.</p>
      <p>For players in my games, this page is a starting point of any campaign for them to dig into the slight changes
        I often use, and for any visitors I hope it can give you ideas and perhaps even introduce you to some new and
    ...
    <div class="main-text">
      <p>The following collection of vetted-by-me homebrew (subject to oversight and at-the-table balancing). The only
        ...
        power up to weapons and weapon users, so please at least skim it. It is marked with an asterisk *.
      </p>
      ...
      <p><span class="inline-subtitle">Aaralyn’s Stolen Notes to Velea</span> (compendium of options) – <a
          class="intext-link" href="https://1drv.ms/b/s!Aq2B34oritBLmC1uFZCTIzL_qRKR"
          target="_blank">https://1drv.ms/b/s!Aq2B34oritBLmC1uFZCTIzL_qRKR</a>
      </p>
      <p><span class="inline-subtitle">Backgrounds Omnibus</span> (compendium of additional backgrounds) – <a
          class="intext-link" href="https://1drv.ms/b/s!Aq2B34oritBLmmPGIbAlsCFavnjS"
          target="_blank">https://1drv.ms/b/s!Aq2B34oritBLmmPGIbAlsCFavnjS</a>
      </p>
      <p><span class="inline-subtitle">Balasar’s Guide</span> (compendium of options) – <a class="intext-link"
          href="https://1drv.ms/b/s!Aq2B34oritBLmBi8yUfLT_OGynmC"
          target="_blank">https://1drv.ms/b/s!Aq2B34oritBLmBi8yUfLT_OGynmC</a>
      </p>
      <p><span class="inline-subtitle">Dark Arts Player’s Companion</span> (compendium of edgy options) – <a
          class="intext-link" href="https://1drv.ms/b/s!Aq2B34oritBLmmw7vzaEhQ2kxHfc"
          target="_blank">https://1drv.ms/b/s!Aq2B34oritBLmmw7vzaEhQ2kxHfc</a>
      </p>
      <p><span class="inline-subtitle">Matt Mercer’s Gunslinger</span> (Fighter subclass) – <a class="intext-link"
          href="https://www.dndbeyond.com/subclasses/gunslinger"
          target="_blank">https://www.dndbeyond.com/subclasses/gunslinger</a>
        however the reload and misfire rules follow those detailed in Armouries of the Second Empire (see below) </p>
      <p><span class="inline-subtitle">Matt Mercer’s Blood Hunter</span> (class) – <a class="intext-link"
          href="https://www.dndbeyond.com/classes/blood-hunter"
          target="_blank">https://www.dndbeyond.com/classes/blood-hunter</a> </p>
      <p><span class="inline-subtitle">Philosopher</span> (class) – <a class="intext-link"
          href="https://drive.google.com/file/d/0B4wSsNjnH-qRQWlMYU1RZGdYdjg/view?usp=sharing"
          target="_blank">https://drive.google.com/file/d/0B4wSsNjnH-qRQWlMYU1RZGdYdjg/view?usp=sharing</a>
      </p>
      <p><span class="inline-subtitle">Revised Artificer</span> (Artificer rework) – <a class="intext-link"
          href="https://1drv.ms/b/s!Aq2B34oritBLmy2oWd_sBThR-6zm"
          target="_blank">https://1drv.ms/b/s!Aq2B34oritBLmy2oWd_sBThR-6zm</a>
      </p>
      <p><span class="inline-subtitle">Soul Binder</span> (class) – <a class="intext-link"
          href="https://www.gmbinder.com/share/-LY7agXq01TYt_qG2nUb"
          target="_blank">https://www.gmbinder.com/share/-LY7agXq01TYt_qG2nUb</a>
      </p>
      <p><span class="inline-subtitle">Wardrow’s Feat Compendium</span> (feat collection) – <a class="intext-link"
          href="https://1drv.ms/b/s!Aq2B34oritBLmyby6lbZfMBsBkBe"
          target="_blank">https://1drv.ms/b/s!Aq2B34oritBLmyby6lbZfMBsBkBe</a>
      </p>
      <p><span class="inline-subtitle">White Necromancer</span> (wizard subclass) – <a class="intext-link"
          href="https://1drv.ms/b/s!Aq2B34oritBLnUmLIu5avGpHTRTq?e=9niWkN"
          target="_blank">https://1drv.ms/b/s!Aq2B34oritBLnUmLIu5avGpHTRTq?e=9niWkN</a>
      </p>
      <p><span class="inline-subtitle">Weapon’s Revised*</span> (rules expansion) – <a class="intext-link"
          href="https://1drv.ms/b/s!Aq2B34oritBLmmrdNLmMeUrxi5kM"
          target="_blank">https://1drv.ms/b/s!Aq2B34oritBLmmrdNLmMeUrxi5kM</a>
      </p>
      <p><span class="inline-subtitle">Witch</span> (class) – <a class="intext-link"
          href="https://1drv.ms/b/s!Aq2B34oritBLo35wW2BENyEExLAI?e=yKOCnW"
          target="_blank">https://1drv.ms/b/s!Aq2B34oritBLo35wW2BENyEExLAI?e=yKOCnW</a>
      </p>
    </div>
    ...
    <div class="main-text">
      ...
      <p><a class="intext-link" href="https://1drv.ms/w/s!Aq2B34oritBLnj8-HQVw6hqZGfYc?e=YTcIEA"
          target="_blank">https://1drv.ms/w/s!Aq2B34oritBLnj8-HQVw6hqZGfYc?e=YTcIEA</a>
      </p>
      ...
      <p><a class="intext-link" href="https://1drv.ms/w/s!Aq2B34oritBLmwCCFfCDkprcPJr6?e=EtBUdW"
          target="_blank">https://1drv.ms/w/s!Aq2B34oritBLmwCCFfCDkprcPJr6?e=EtBUdW</a>
      </p>
      <p><span class="inline-subtitle">Prestigious D&amp;D</span> – a homebrew document that details a module of rules
        ...
        here; </p>
      <p><a class="intext-link" href="https://1drv.ms/w/s!Aq2B34oritBLkVXKUDJP9LuwzgIY"
          target="_blank">https://1drv.ms/w/s!Aq2B34oritBLkVXKUDJP9LuwzgIY</a>
      </p>
    </div>
    ...
    <div class="main-text">
      ...
      <p><span class="inline-subtitle">Background Feat &amp; Normal+ Humans*</span> – you pick one feat at character
        creation, as if you have a character level of 1 (but otherwise classless), in addition to normal character
        creation. However, this feat must be related to your background, such as Skulker for the Criminal background.
        This can be any available feat as allowed by the core or expanded rules, such as Prestigious D&amp;D&#39;s
        Secondary Swap out. Because of this, the variant human is not available. Instead you&#39;re a &quot;Normal
        Human+&quot;, using the non-variant human plus an additional Skill Proficiency of your choice and an additional
      ...
      <p><span class="inline-subtitle">Skill Per Intelligence*</span> – intelligence is one of the weakest statistics
        mechanically, leading many to take it as a dump statistic and shoe-horning their character to be played as a
        dumbass (though sometimes this can be fun, no mistake, it should be a choice not a compromise). In an attempt to
        reconnect Intelligence to Skills, their old
      ...
      <p>In the unlikely situation where high level rogues or bards find themselves with more expertise than skills,
        they can instead take a skill proficiency.
      </p>
      <p><span class="inline-subtitle">Sprinting &amp; Chasing</span> – you can spend your movement, action and bonus
        action (your entire “turn”) to move 5 times your speed in a straight line, provoking opportunity attacks as
        normal. Movement in 5e is “combat
    ...
    <PointBuyCalculator id="PBCalc" />

  </section>
</template>

<script setup>
import PointBuyCalculator from '../components/PointBuyCalculator.vue';
