...
#### Name
WIP - Enter your character's Name.
<div id="character-name"></div>

#### Concept
WIP - Enter your character's Concept
<div id="character-concept"></div>

#### Bonds, Ideals and Flaws
WIP - Enter your character's Bonds, Ideals and Flaws. At least 1 of each.
...
The base statistics of a character are [-2, -1, 0, 0, +1, +2]. Alternatively, dice rollers can roll 4d6, reducing each result by -4, and then roll another 4d6 reducing each result by -3. Record each value. Discard 2 dice so that the rolls add up to a value from 2 to -2, rerolling all 8 dice if you cannot.

Stats are primarily affected by your Race, and secondarily bumped up by your Background and your Role.
...
If you get involved in matters of the divine, your Faith as a statistic becomes important, although other characters are also welcome to have and track their Faith (note, do not calculate Faith like other Statistics, instead see Divine Spellcasting):
- **Faith** - the attunment of your soul to the divine path of your deity / deities / philosophy.
...
- **Reflexes** - the ability of the body and your awareness to avoid harms. Calculated from **Accuracy** + **Perception**.
- **Willpower** - the ability of the mind to resist. Calculated from **Intelligence** + **Charisma**.

#### Difficulty Class and Resistance DC's
A term I've carried over is "Difficulty Class", a.k.a. "DC", meaning the target number you must meet or beat to succeed a dice roll. Sometimes enemy attacks and other effects are made against your "Resistance DC", this is 8 + the Resistance value.
