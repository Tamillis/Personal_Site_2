...
**Proficiency** - having Proficiency allows you to apply your **Bonus** to a skill check. Every Proficiency is a Bonus, but not all Bonuses are from Proficiencies, to be clear.

**Bonus** - due to various sources, Powers, Skill Proficiencies etc, GM fiat, you may be able to add a Bonus to a roll. Except in exceptional circumstances the GM and the table feel are valid, you don't gain more than 1 Bonus to a roll at a time. The common exception to this are certain Powers which state "a +X bonus in addition to any proficiency". Initially, "Bonus" is a +2 increase.

A special powerful Power, “Aptitude”, increases the value of your Bonus to +3, then +4 and finally +5.

**Expertise** - Certain Powers can grant Expertise to certain Skills or circumstances which specifically means the Bonus is doubled. Every area of the game that grants Expertise only does so when that area already has a Proficiency Bonus, otherwise it is treated as a regular Bonus. An area of the game which already benefits from Expertise cannot benefit from it again. As weapons are just another kind of Skill, Martial Skills, you can benefit from Expertise with them.
