...
### Size
Your size determines the physical space you occupy (in terms of combat spacing, not literal physical width!), as well as base scores for your Health and Evasion.
