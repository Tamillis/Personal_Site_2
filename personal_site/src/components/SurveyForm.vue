<template>
    <div class="main-text">
        <form @submit="handleSubmit" action="/surveydata" target="" method="POST" v-if="firstTimeSubmit==null" class="section">
...
let countriesArray = await fetch("src/assets/countries.json").then(res => res.json());
