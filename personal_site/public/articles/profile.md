...
Before then, I was a trainer at Sparta Global, where I trained cohorts of fresh-faces, most of whom have only a smidgen of programming experience, to become industry-standard developers and automation testers using C#.NET, Entity Framework as an ORD with SqlServer, and Selinum & NUnit with SpecFlow for automated unit and integration tests. The goal of the course was to get students to become effective on-site team members after only 2 months of intense training.

This personal site is proof of my full stack development capability - a Vue front end, Markdown content, with a node api backend and a mix of JSON and SQLite as my data layer. The first iteration of this site was the culmination of my self-study (I was fully self-taught).

In my live I've also been an English Foreign Language teacher - for 6 years living and working in Spain, Slovakia, the UK, Sweden and Japan. I am a fluent speaker of Japanese - having worked as a translator (and being married to a Japanese national). I'm also a conversational Swedish speaker, and dabbler in many other various languages and linguistics.

Personally, I'm a happily married man to a lovely wife with a young son of 1. I'm a world traveller (places I've been in highlighted red on the globe there) and a massive TTRPG geek (Shadow of the Demon Lord being my current heroic-fantasy go-to).

As you can probably see in my picture, I'm also a corgi owner and all-around dog-person!
...
If you have any questions or enquiries, please feel free to contact me via LinkedIn (links in sidebar).
...
_**Programming, IT & Web Development**_: I'm an IT & system administrator capable of coding in wide array of languages as well as running and outfitting a business' IT needs from phones to servers. I professionally use C#.NET, SQL Server, and Vue, using Azure and Git, and following Agile sprint workflows. I am familiar with many more software suites.

I'm a stickler for best practices, such as SOLID, Design Patterns (used appropriately!), DRY & DAMP, and especially KISS. Any software or framework I need to learn to produce projects I'm happy to do, and I though I love to work at a project from ideation to deployment, I'm also confident and practiced in picking up code, and handing it over to the next head in the chain when the time comes.

At home I am a Windows and Linux user (both Debian and Arch based). I run my own self-hosted VPS as a headless server interacting purely through the terminal and bash scripting. Putting Lubuntu on an old Windows Surface Pro was a fun project I underwent once. I also build computers as a hobby, and know them literally inside and out. My personal computer is a Frankensteinian creation of parts that have gone through a steady cycle of upgrades over the years, and countries!

_**Languages**_: Another passion of mine, I speak Japanese fluently, Swedish conversationally and I'm working on Esperanto. I hold a JLPT N2 level equivalent level of Japanese, conversing at a native level (and at a business level for 3 years), and a B1+ (CEFR) level in Swedish. Through past endeavours I also have a foundational understanding of Spanish, German, French and linguistics.

***Public Facing***: from working in a 5-star hotel, to presenting workshops to members of the public, to liaising with clients to design websites, I am unfailingly polite and communicate well while also being a highly-technical individual, having honed many other people and soft skills extensively in the teaching industry and in business. I pride myself on my professional attitude in work, and my charming and approachable manner.

***Media Production***: in my previous position at Sparta I have been heavily involved in producing professional quality educational videos and articles for internal and external use, producing the entire process of scripting, filming and editing. My videos and articles were published by the company for tech interest.
...
### _**Royal Holloway University of London - Studying Physics**_

*Dates*: September 2012 to June 2015

I studied Physics at Royal Holloway for 2 years, taking a break in the middle, earning a Certificate of Higher Education in Physics. I decided to move on to earn my TEFL qualification than continue to a 3rd year. During my time at university I was the secretary for the Karate club, organising member of the Japan society, and department representative during open-days.

### _**Solihull 6th Form College**_

*Dates*: September 2010 to May 2012

I studied for my A-levels and AS-levels in Physics, Chemistry, Computing and Mathematics.